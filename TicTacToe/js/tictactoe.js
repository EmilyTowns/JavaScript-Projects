...
let activePlayer = 'X';
//This array stores an array of moves. We use this to detirmine win conditions.
let selectedSquares = [];

//This function is for placing an x or o in a square.
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't been selected already.
    //This .some() method is ued to check each element of selectedSquare array to see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition checks to see it it is computers turn.
        if(activePlayer === 'O') {
    ...
    function computersTurn() {
        ...
        while(!success) {
            //A randdom number between 0 and 8 is selected
...
function checkWinConditions() {
    ...
    //It is used the check for each win condition.
...
//This function ultilizes html canvas to draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    animateLineDrawing();
    //This line wits 1 second. Then, clears canvas, resets game, and allows clicking again.
